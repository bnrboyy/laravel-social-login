...
@section('content')
    <div class="flex relative py-20 bg-gradient-to-br from-sky-50 to-gray-200 h-full min-h-screen">
                    ...
                    <div class="p-6 sm:p-16">
                        ...
                        <div class="mt-16 grid space-y-4">
                            <a href="{{ route('google.login') }}">
                                <button
                                    class="group w-full h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                            ...
                            <a href="{{ route('facebook.login') }}">
                                <button onclick="facebookLogin()"
                                    class="group w-full h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300
